...
class TestCodelesssample():
  ...
  def test_codelesssample(self):
    ...
    self.driver.set_window_size(1050, 653)
    self.driver.find_element(By.ID, "login_link").click()
    self.driver.find_element(By.ID, "id_registration-email").click()
    self.driver.find_element(By.ID, "id_registration-email").send_keys("tyuiolkjhgbnmm@testy.com")
    self.driver.find_element(By.ID, "id_registration-password1").click()
    self.driver.find_element(By.ID, "id_registration-password1").send_keys("!@#$%^&*900")
    self.driver.find_element(By.ID, "id_registration-password2").click()
    self.driver.find_element(By.ID, "id_registration-password2").send_keys("!@#$%^&*900")
